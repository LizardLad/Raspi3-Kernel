...
static int core1_execute_lock = 0;
static int core2_execute_lock = 0;
static int core3_execute_lock = 0;
...
volatile void (*core1_jump_func_ptr) (void *);
volatile void (*core2_jump_func_ptr) (void *);
volatile void (*core3_jump_func_ptr) (void *);

volatile bool core1_execute = false;
volatile bool core2_execute = false;
volatile bool core3_execute = false;
...
void core_wait_for_instruction()
{
	...
	init_page_table(); //Create mmu table on core x
	mmu_init();
